...
*/
    ...
    while($dato = mysql_fetch_row($result)){
             ...
             echo "<br><div style=\"width:259px; height:124.5px;margin-left:-50px;margin-top:-40px;position:absolute;top:-15%;clear:both;\"><br><div align=center  ><p><img height=\"52\" width=\"172\" src=barcode/barcode.php?text=".$dato[0]."/></p>";
             echo "<p>$dato[1]</p>";
