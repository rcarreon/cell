...
*/
    ...
    while($dato = mysql_fetch_row($result)){
             ...
             echo "<br><div style=\"width:259px; height:124.5px;margin-left:-40px;margin-top:-65px;margin-bottom:-25px;position:relative;top:70%;clear:both;\"><br><div align=center  ><p><img height=\"32\" width=\"182\" src=barcode/barcode.php?text=".$dato[0]."/></p>";
