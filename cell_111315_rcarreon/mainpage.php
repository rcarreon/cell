...
function optionCheck5(){
		var option4 = $('#opsearch5 option:selected').val();
		switch (option4) {
			case "agregarm":
		...
		<div   class = "container" id="agregaf" style="display:none;">			
			<form   name="agrega" method="post" id="aagrega"><strong>
				...
				<div>		
					...
					<div class="f_agrega">
						<input type="text" name="a_cliente" id="a_cliente" class="s_cliente_auto" placeholder="Ingresa Cliente" tabindex=1 style="text-transform:uppercase;" value="ROB">	
					</div>
					
					<div style="position:absolute;top:28px;left:55%;">
						Imei:
						<div>
				 			<input type="text" name="a_imei" id="a_imei" class="s_imei_auto" placeholder="Ingresa Imei" tabindex=2 style="text-transform:uppercase;" value="192837123">
				 		</div>
			    	</div>
					Equipo marca: 
					<div class="f_agrega" >
					...
					<div style="position:absolute;top:95px;left:55%;">
						Equipo modelo:
						<div class="f_agrega" >
							<input type="text" id="a_mmodelo" name="a_mmodelo" class="s_modelo_auto" placeholder="Ingresa Equipo" tabindex=3  style="text-transform:uppercase;" >
						</div>
					</div>
					Fecha y hora:
					<div>
						<input class="datte" type="text" name="a_fecha" id="a_fecha" value="<?php  date_default_timezone_set('America/Hermosillo'); $date = date('Y-m-d         H:m:s'); echo $date; ?>" tabindex=3 style="text-transform:uppercase;">
					</div>

					<div style="position:absolute;top:150px;left:55%;">
			    	Contrasena:
			    		<div>
							<input type="text" id="a_password" name="a_password" placeholder="Ingresa Contraseña" tabindex=8  style="text-transform:uppercase;" value="Contrasena">				
						</div>
					</div>
					<div style="position:absolute;top:210px;left:55%">
					...
					<div class="f_agrega">
				 		<input type="radio" name="a_status" id="a_status"   class="lis" value="Garantia" tabindex=4 >Garantia <font color="red">*</font>
						<input type="radio" name="a_status" id="a_status"  class="rep" value="En reparacion" tabindex=5 >Nuevo Ingreso <font color="red">*</font>				   			   		
			   		</div>  <br>	    
			   		Detalles Tecnicos:
			    	<div>			
			    		<textarea maxlength="115" type="text" id="a_detalles" name="a_detalles" placeholder="Detalles Servicio Tecnico" tabindex=7 style="text-transform:uppercase;" value="LOQUE SEA QUE SE LE HAYA ROTO"></textarea>					
			    	</div>
			    	<div style="position:absolute;top:270px;left:55%" >
			    		Accesorios:
			    			<div>
			    			    <textarea maxlength="115" type="text" id="a_access" name="a_access" placeholder="Accesorios" tabindex=7 style="text-transform:uppercase;" value="Una moto"></textarea>					
			...
			<button  style="position:absolute;bottom:5%;left:65%;"  id="limpia" type="button" tabindex=12>Limpiar datos</button>												
			<a href="/" >
   			<button style="position:absolute;bottom:5%;left:85%;" type="button" tabindex=11>Regresar</button>
			</a>
